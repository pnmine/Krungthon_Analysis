...
<html>
    ...
    <body>
        <p class="tx">Phone charge</p>
        
        <form action="../handlers/phone_handle.php" method="get">
        <div class="main-form"> 
        <div class="form">   
        ...
        <div class="text1">Phone information</div>
        <div class="main1">
            <div class="box1">     
                Phone number : <input type="text" name="phoneNum" style="background-color: #e3e0e0; ">
            </div>    
        </div>         
                
        <div class="text1">Charge detail</div>
        <div class="main1">
            <div class="box1">
                <p class="form-text1">Charge amount : <input type="text" name="amount" style="background-color: #e3e0e0; "></p>
